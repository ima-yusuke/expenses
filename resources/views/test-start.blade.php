            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="bg-white/80 backdrop-blur-sm border border-primary-100 rounded-2xl p-10 shadow-soft-lg">
                    ...
                    <form method="GET" action="{{route('StartTest')}}" class="space-y-8">
                        <div class="space-y-4">
                            <label class="block text-sm font-semibold text-primary-900 text-center mb-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <label class="relative flex items-center justify-center cursor-pointer">
                                    ...
                                    <div class="w-full bg-white border-2 border-primary-200 peer-checked:border-accent-500 peer-checked:bg-accent-50 rounded-xl px-6 py-8 transition-all duration-200 peer-checked:shadow-soft-lg hover:border-accent-300">
                                        <div class="flex flex-col items-center">
                                            <svg class="w-12 h-12 mb-3 text-primary-600 peer-checked:text-accent-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                                            </svg>
                                            <span class="text-3xl font-bold text-primary-900 mb-1">10</span>
                                            <span class="text-sm text-primary-600">問</span>
                                            <span class="text-xs text-primary-500 mt-2">約5分</span>
                                        </div>
                                    </div>
                                </label>
                                <label class="relative flex items-center justify-center cursor-pointer">
                                    ...
                                    <div class="w-full bg-white border-2 border-primary-200 peer-checked:border-accent-500 peer-checked:bg-accent-50 rounded-xl px-6 py-8 transition-all duration-200 peer-checked:shadow-soft-lg hover:border-accent-300">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <span class="text-3xl font-bold text-primary-900 mb-1">20</span>
                                            <span class="text-sm text-primary-600">問</span>
                                            <span class="text-xs text-primary-500 mt-2">約10分</span>
                                        </div>
                                    </div>
                                </label>
                                <label class="relative flex items-center justify-center cursor-pointer">
                                    ...
                                    <div class="w-full bg-white border-2 border-primary-200 peer-checked:border-accent-500 peer-checked:bg-accent-50 rounded-xl px-6 py-8 transition-all duration-200 peer-checked:shadow-soft-lg hover:border-accent-300">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <span class="text-3xl font-bold text-primary-900 mb-1">30</span>
                                            <span class="text-sm text-primary-600">問</span>
                                            <span class="text-xs text-primary-500 mt-2">約15分</span>
                                        </div>
                                    </div>
                                </label>
                            </div>
                        ...
                        <div id="loadingIndicator" class="hidden">
                            <div class="bg-gradient-to-br from-accent-50 to-accent-100 border-2 border-accent-300 rounded-xl p-8 text-center shadow-soft">
                                ...
                                <p class="text-primary-900 font-semibold text-lg mb-2">問題を生成中です</p>
                                <p class="text-primary-600">少々お待ちください（10-20秒程度）</p>
                            </div>
                        </div>
                    </form>
